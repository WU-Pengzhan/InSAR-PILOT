...
class DemSection(DownloadSection):
    """DEM source selection and optional OpenTopography credentials."""
    ...
    def __init__(self, parent=None) -> None:
        ...
        self.download_dem_checkbox.setEnabled(True)
        ...
        self.dem_source_combo.setEnabled(True)
        ...
        IconProvider.apply(self.test_opentopography_button, "check")
    ...
    def set_opentopography_available(self, available: bool) -> None:
        """Record whether credentialed OpenTopography sources are available."""
