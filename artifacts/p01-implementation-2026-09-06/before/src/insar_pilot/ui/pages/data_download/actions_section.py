...
class ActionsSection(DownloadSection):
    ...
    def __init__(self, parent=None) -> None:
        ...
        IconProvider.apply(self.select_all_button, "check")
        IconProvider.apply(self.select_none_button, "cancel", "muted")
        IconProvider.apply(self.save_selected_button, "save")
        IconProvider.apply(self.download_selected_button, "download")
        IconProvider.apply(self.cancel_download_button, "cancel", "error")
        IconProvider.apply(self.use_as_sources_button, "import")
        IconProvider.apply(self.open_workspace_button, "folder")
