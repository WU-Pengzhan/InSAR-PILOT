...
class RunMonitorPage(QWidget):
    ...
    def refresh_translations(self) -> None:
        ...
        self.current_step_card.title_label.setText(tr("monitor.card.step.title"))
        self.work_dir_card.title_label.setText(tr("monitor.card.work_dir.title"))
        self.run_wizard_bar.run_button.setText(tr("monitor.wizard.run_next"))
        self.run_step_monitor.refresh_translations()
