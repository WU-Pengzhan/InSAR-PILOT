...
class GeometryVerifyPanel(QWidget):
    ...
    MINIMUM_INTERACTIVE_VIEW_HEIGHT = 380
    MINIMUM_INTERACTIVE_PANEL_HEIGHT = 430
    ...
    def __init__(self, parent=None, *, show_controls: bool = True) -> None:
        ...
        if show_controls:
            self.view.setMinimumHeight(self.MINIMUM_INTERACTIVE_VIEW_HEIGHT)
            self.setMinimumHeight(self.MINIMUM_INTERACTIVE_PANEL_HEIGHT)
