...
[中文](README.md) · [Current architecture](docs/architecture/overview.md) · [Implementation status](docs/architecture/migration.md) · [Sentinel page proposal](docs/architecture/sentinel-workbench.md)
...
Discuss screen responsibilities first, then design and deliver one agreed page at
a time. The five-page Sentinel proposal is not yet an implemented or approved redesign.
