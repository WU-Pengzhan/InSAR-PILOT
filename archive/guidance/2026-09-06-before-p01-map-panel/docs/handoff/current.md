...
更新时间：2026-09-06。当前任务：**P01 与公共外壳布局修正已完成定向测试，P01 整体验收继续保留原待办**。
最新接续入口：[地图加宽修正](records/2026-09-06-p01-wider-map.md)：用户否定等宽方案，现为 300—340px 筛选栏和占剩余宽度的 16:9 参考地图。此前五主入口、左栏调宽/横滚、环境折叠和底图状态恢复保持。
