...
class DataSourcesPage(QWidget):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self.dem_card = SummaryCard("DEM", "Not set", "GeoTIFF or prepared DEM path.")
        ...
        self.isce_root_row.line_edit.setPlaceholderText(
            "Required: processing runtime root or conda env prefix"
        )
        env_form.addRow("Shell init", self.shell_init_row)
        env_form.addRow("Conda env", self.conda_env_edit)
        env_form.addRow("Runtime root", self.isce_root_row)
