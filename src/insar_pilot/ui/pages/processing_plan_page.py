...
class ProcessingPlanPage(QWidget):
    ...
    def __init__(self, parent=None) -> None:
        ...
        form.addRow("Parallel tasks (--num_proc)", self.num_proc_spin)
        ...
        self.preflight_text.setPlaceholderText("Preflight path, environment, and conflict checks will appear here.")
