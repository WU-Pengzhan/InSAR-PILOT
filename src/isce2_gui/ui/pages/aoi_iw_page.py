"""Unified AOI + ISCE bbox + IW selection page."""
...
from isce2_gui.ui.widgets.geometry_verify_panel import GeometryVerifyPanel
...
class AoiIwPage(QWidget):
    """Single entry point to finalize isce2 bbox and IW parameters."""
    ...
    def __init__(self, parent=None) -> None:
        ...
        cards = QHBoxLayout()
        cards.setSpacing(12)
        self.source_card = SummaryCard("AOI Source", "Manual", "AOI file can auto-fill isce2 bbox.")
        self.bbox_card = SummaryCard("ISCE BBox (SNWE)", "Not set", "Final processing bbox in decimal degrees.")
        ...
        self.use_common_overlap_check = QCheckBox("Use common overlap (allow empty isce2 bbox)")
        ...
        helper = QLabel(
            "AOI file is user input data. ISCE bbox is a processing parameter (SNWE decimal degrees). "
