...
from isce2_gui.ui.widgets.preview_panel import PreviewPanel
...
class ResultsPage(QWidget):
    ...
    def __init__(self, parent=None) -> None:
        ...
        cards = QHBoxLayout()
        cards.setSpacing(12)
        self.output_card = SummaryCard("Outputs", "Not scanned", "Browse native ISCE outputs and quicklooks.")
        self.preview_card = SummaryCard("Preview", "Idle", "Generate SLC, interferogram, or overlay quicklooks.")
        cards.addWidget(self.output_card, 1)
        cards.addWidget(self.preview_card, 1)
        ...
        visual_form.setSpacing(10)
        visual_form.setLabelAlignment(Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
        ...
        visual_form.addRow("Mode", self.visual_mode_combo)
        visual_form.addRow("Primary input", self.visual_primary_row)
        visual_form.addRow("Secondary input", self.visual_secondary_row)
        visual_form.addRow("Export directory", self.visual_export_dir_row)
        visual_form.addRow("Range looks (rlks)", self.visual_range_looks_spin)
        visual_form.addRow("Azimuth looks (alks)", self.visual_azimuth_looks_spin)
        visual_form.addRow("Overlay brightness", self.visual_overlay_brightness_spin)
        self.visual_section.content_layout.addLayout(visual_form)
        ...
        self._secondary_label = visual_form.labelForField(self.visual_secondary_row)
        self._brightness_label = visual_form.labelForField(self.visual_overlay_brightness_spin)
